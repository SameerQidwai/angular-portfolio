...
export class ListingListComponent {
  ...
  item_personalcar: boolean = false;
  item_electriccar: boolean = false;
  item_vans: boolean = false;
  item_cars: boolean = false;
  item_truck: boolean = false;
  item_hybrid: boolean = false;
  search: string = '';
  ...
  ,
    ...
    private metaService: Meta,) {
      ...
      if(this.app.record_validation(this.actRoute.snapshot.paramMap.get('id'))){
        if(this.actRoute.snapshot.paramMap.get('id') == '1'){
          this.item_personalcar = true;
        } 

        if(this.actRoute.snapshot.paramMap.get('id') == '2'){
          this.item_electriccar = true;
        } 

        if(this.actRoute.snapshot.paramMap.get('id') == '3'){
          this.item_vans = true;
        } 

        if(this.actRoute.snapshot.paramMap.get('id') == '4'){
          this.item_cars = true;
        } 
  
        if(this.actRoute.snapshot.paramMap.get('id') == '5'){
          this.item_truck = true;
        } 
  
        if(this.actRoute.snapshot.paramMap.get('id') == '6'){
          this.item_hybrid = true;
        } 
      }

      this.currentPath = window.location.pathname;
      if(this.currentPath == '/elbiler'){
        this.item_electriccar = true;
      } 

      if(this.currentPath == '/varebiler'){
        this.item_vans = true;
      } 

      if(this.currentPath == '/personbiler'){
        this.item_personalcar = true;
      } 

      if(this.currentPath == '/hybrid'){
        this.item_hybrid = true;
      } 
  }
